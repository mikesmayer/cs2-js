                ...
                m('.w-col.w-col-3.u-marginbottom-10', [
                    ...
                    m('.fontsize-smallest',
                        ...
                        (contributionVM.canShowReceipt(contribution) ?
                            m(`a.btn.btn-inline.btn-small.u-margintop-10.btn-terciary[href='https://www.catarse.me/en/projects/${contribution.project_id}/contributions/${contribution.contribution_id}/receipt'][target='__blank']`,
                                'Ver recibo'
                            ) : ''),
                        ...
                        (contributionVM.canGenerateSlip(contribution) ?
                            m(`a.btn.btn-inline.btn-small.u-margintop-10[href='https://www.catarse.me/en/projects/${contribution.project_id}/contributions/${contribution.contribution_id}/second_slip'][target='__blank']`,
                                'Gerar 2a via'
                            ) : ''),
