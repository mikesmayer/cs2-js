...
var menu = {
    ...
    view: function view(ctrl, args) {
        return m('header.main-header', {
            ...
            } }, 'Comece seu projeto'), m('a.header-link.w-nav-link[href=\'/en/explore?ref=ctrse_header\']', { onclick: function onclick() {
